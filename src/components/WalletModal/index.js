        ...
        <UpperSection>
          ...
          <ContentWrapper>
            {error instanceof UnsupportedChainIdError ? (
              <h5>Please switch your network or connect to the appropriate network.<br/> (Currently we only support Base goerli network)</h5>
            ) : (
              ...
              <InfoCard>
                <AccountGroupingRow>
                  ...
                  <div>
                    <button
                      type="button"
                      className="text-red-700 hover:text-white border border-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-2 py-1 text-center mr-2 mb-2"
                      onClick={() => {
                        deactivate();
                      }}
                    >
                    ...
                    <button
                      type="button"
                      className="text-[var(--primary)] hover:text-white border border-red-700 hover:bg-[var(--primary)] focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-2 py-1 text-center mr-2 mb-2"
                      onClick={() => {
